(function () {
    ...
    var Game = /** @class */ (function () {
        ...
        Game.prototype.dests = function () {
            return chessgroundDests(this.chess);
        };
        Game.prototype.play = function (orig, dest) {
    ...
    var Board = /** @class */ (function () {
        ...
        Board.prototype.start = function (el) {
            var _this = this;
                ...
                movable: {
                    events: {
                        after: function (orig, dest) {
                            _this.game.play(orig, dest);
                            ground.set({
                                turnColor: _this.game.turn(),
                                movable: {
                                    color: _this.game.turn(),
                                    dests: _this.game.dests()
                                },
                                check: _this.game.isCheck()
                            });
                        }
                    }
                }
